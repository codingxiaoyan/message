package com.vprivacy.message;

import com.vprivacy.message.common.constant.MessageConstant;
...
public class MessageApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        log.info(AnsiOutput.toString(MessageConstant.PROJECT_BANNER, "\n", AnsiColor.GREEN, MessageConstant.PROJECT_NAME, AnsiColor.DEFAULT, AnsiStyle.FAINT));
